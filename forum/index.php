...
$GLOBALS['xoopsOption']['template_main'] = 'forum/xfmod_index.html';
...
if ($group_id) {
    ...
    $sql = 'SELECT g.group_forum_id,g.forum_name,g.description, famc.count as total '
              ...
              . ' g '
              . 'LEFT JOIN '
              . $xoopsDB->prefix('xf_forum_agg_msg_count')
              . ' famc USING (group_forum_id) '
    ...
    $extsql = 'SELECT forum_name,forum_url FROM ' . $xoopsDB->prefix('xf_forum_ext_group_list') . " WHERE group_id='$group_id'";
