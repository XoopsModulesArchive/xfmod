...
require_once XOOPS_ROOT_PATH . '/modules/xfsnippet/language/english/modinfo.php';
require_once XOOPS_ROOT_PATH . '/modules/xfmod/language/english/snippet.php';
...
$content = '<p>Code Snippets are essentially code samples.  A code snippet is a piece of '
           ...
           . 'The "'
           . _XF_XFSNIPPET_NAME
           . '" section contains both code snippets and snippet '
...
$content = '<p>To get to the Code Snippets section, click on the "'
           . _XF_XFSNIPPET_NAME
...
$content = '<p>It is easy to create a new code snippet.  Begin by clicking on the "'
           ...
           . 'Click on the "'
           . _XF_SNP_SUBMITNEWSNIPPETVERSION
           . '" link, fill in the form, and '
           . 'submit.';
...
$content = 'One way to manage snippets is to create a snippet package of related snippets.  '
           . 'You create a package by first clicking the "'
           . _XF_SNP_CREATEAPACKAGE
           . '" link, '
           ...
           . _XF_SNP_SUBMITNEWVERSION
           . '" link, then fill in the '
