...
function help_menu($where)
{
    ...
    echo "<table border='0' cellpadding='0' cellspacing='0' width='100%'><tr><td height='1' style='background-image:url("
         . XOOPS_URL
         . "/modules/xfmod/images/dotlinebg_horiz.gif)'><img src='"
         . XOOPS_URL
         . "/modules/xfmod/images/spacer.gif' width='173' height='1' border='0' alt=''></td><td width='20'></td></tr></table>";
    ...
    foreach ($helpmenu as $menu_item => $submenu) {
        if (0 == strcasecmp($where, $menu_item)) {
            ...
            foreach ($submenu as $submenu_item) {
                $sm .= '<li><a href="' . $_SERVER['PHP_SELF'] . '#' . strtr(mb_strtolower($submenu_item), ' ', '_') . "\">$submenu_item</a></li>";
            }

            $sm .= '</ol>';
        } else {
            echo '<a href="' . strtr(mb_strtolower($menu_item), ' ', '_') . ".php\"><span style='white-space: nowrap;'> $menu_item </span></a>";
        }
    ...
    echo "<table border='0' cellpadding='0' cellspacing='0' width='100%'><tr><td height='1'></td></tr><tr><td height='1' style='background-image:url("
         . XOOPS_URL
         . "/modules/xfmod/images/dotlinebg_horiz.gif)'><img src='"
         . XOOPS_URL
         . "/modules/xfmod/images/spacer.gif' width='173' height='1' border='0' alt=''></td><td width='20'></td></tr></table>";
