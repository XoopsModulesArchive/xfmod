...
define('_XF_MY_AVAILABLE_SUBS', 'The following additional subscriptions are available. Enter and verify a mailing list password to subscribe. <i>Do not use a secure password</i>.');
...
define(
    ...
    'Operation Not Permitted<br>You cannot remove yourself from this project, because '
    ...
    . "/modules/xfjobs/createjob.php?group_id=%s'>Help Wanted Board</a> and be ready to "
    // %s is group_id
