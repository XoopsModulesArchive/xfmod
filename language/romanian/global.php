...
define('_XF_FRS_ADDCHANGELOGFAILED', 'FRS Add Change Log Failed');

define('_XF_FRS_ADDFILEFAILED', 'FRS Add File Failed');
...
define('_XF_FRS_ADDRELEASEFAILED', 'FRS Add Release Failed');

define('_XF_FRS_ADDNOTESFAILED', 'FRS Add Notes Failed');

define('_XF_FRS_CHANGEPACKAGENAMEFAILED', 'FRS Change Package Name Failed');

define('_XF_FRS_CHANGEFILEFAILED', 'FRS Change File Failed');

define('_XF_FRS_CHANGEFILERELEASEFAILED', 'FRS Change File Release Failed');

define('_XF_FRS_CHANGERELEASEFAILED', 'FRS Change Release Failed');

define('_XF_FRS_GETRELEASELISTFAILED', 'FRS Get Release List Failed');

define('_XF_FRS_GETRELEASEFAILED', 'FRS Get Release Failed');

define('_XF_FRS_GETRELEASEFILESFAILED', 'FRS Get Release Files Failed');

define('_XF_FRS_VERIFYFILEOWNERSHIPFAILED', 'FRS Verify File Ownership Failed');

define('_XF_FRS_VERIFYRELEASEFAILED', 'FRS Verify Release Failed');

define('_XF_FRS_VERIFYPACKAGEFAILED', 'FRS Verify Package Failed');

define('_XF_FRS_VERIFYPACKAGENAMEFAILED', 'FRS Verify Package Name Failed');

define('_XF_FRS_VERIFYFILEFAILED', 'FRS Verify File Failed');

define('_XF_FRS_VERIFYFILERELEASEFAILED', 'FRS Verify File Release Failed');

define('_XF_FRS_FILEALREADYEXISTS', 'File Already Exists');

define('_XF_FRS_VERIFYPROJECTFAILED', 'FRS Verify Project Failed');

define('_XF_FRS_VERIFYRELEASEDATEFAILED', 'FRS Verify Release Date Failed: invalid date format');

define('_XF_FRS_CREATEPACKAGEFAILED', 'FRS Create Package Failed');

define('_XF_FRS_SENDNOTICEFAILED', 'FRS Send Notice Failed');

define('_XF_FRS_RESOLVERELEASEFAILED', 'FRS Resolve Release Failed');
