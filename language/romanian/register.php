...
define(
    '_XF_REG_ISSUBMITTED',
    '<p>Your ' . $type . ' application has been submitted to the XOOPS Development Forge admininstrators. Within 72 hours, you will receive decision notification and further instructions.
</p>
<p>
Upon approval you`ll get a project space in the Forge and access complete with forums, project trackers, statistics, news
publishing tools. You`ll also get access to private dev-to-dev forums where you can ask your questions and submit your issues.</P>
<P>
The XOOPS Development Forge uses the sourceforge.net XOOPS project CVS for all it`s CVS activities. If you require CVS for your project, please signup at <a href="http://sourceforge.net/account/register.php">http://sourceforge.net/account/register.php</a>, and report your username to
<a href="mailto:development@xoops.org">development@xoops.org</a>.</P>
'
);
define('_XF_REG_ISACTIVATED', 'Your ' . $type . ' has been successfully activated. You can visit your ' . $type . ' page at this location');
define('_XF_REG_THANKYOU', 'Thank you for signing up your XOOPS Module Development project with the XOOPS Development Forge.');
...
define(
    '_XF_REG_STEPA',
    '
<p><b>You want to host your XOOPS Module Development project here on the XOOPS Development Forge.
Doing this gives you the advantage of being close to where the action is, being able to talk to other XOOPS Module developers, see
good examples, and you get to show off your own prowess.</p>
<p>To apply for a new development project, we will need some information about the project. Please fill in this form and we will contact you
