...
function grpGetApprovalMessage($unix_group, $full_group, $group_id, $type = 1)
{
    ...
    $message['body'] = 'Deine '
                          ...
                          . "\n"
                          . "\n"
                          . 'Nimm dir etwas Zeit und lese die Site-Dokumentation über '
                          . $prjtype
                          . ' '
                          . 'Administration (<'
                          . $xoopsConfig['xoops_url']
                          ...
                          . $uprjtype
                          . " Admin' aus den Menüs "
                          . 'oben auswählst (oder durch den Besuch von <'
                          . $xoopsConfig['xoops_url']
                          . '/modules/xfmod/'
                          . $prjtype
                          . '/admin/?group_id='
                          ...
                          . 'HINWEIS: Dein '
                          . $prjtype
                          . ' wird auch nicht auf der Fund Software Map auftauchen (primäre '
                          . 'Liste von '
                          . $plprjtype
                          ...
                          . 'Besuche dein '
                          . $prjtype
                          . " wenn du eingeloggt bist und wähle '"
                          . $uprjtype
                          . " Admin' aus "
                          . "den Menüs oben.\n"
                          . "\n"
