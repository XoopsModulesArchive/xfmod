...
?>
<p>
<h2>myXoopsForge Terms of Service Agreement</h2>
</p>
<p>
    <B>1. ACCEPTANCE OF TERMS</B>
</p>
<p>
    A person's use of myXoopsForge and any of its Services (as defined below) at
    any time is subject to myXoopsForge's then-current Terms of Service ("TOS"),
    which may be updated from time to time as set forth below. Each user can
    review the then-current TOS at any time at:
    <a href="http://www.rcp-forge.org/modules/xfmod/tos/tos.php">http://www.rcp-forge.org/modules/xfmod/tos/tos.php.</a>. In addition, each user's use of
    ...
    reference into the TOS. A user's use of myXoopsForge and/or its Services
    constitutes full acceptance of and agreement to the TOS; if a user does not
    accept our TOS, he or she is not granted rights to use myXoopsForge or any of
    its Services, as defined herein, and should refrain from accessing
    myXoopsForge and its Services.
</p>
<p>
    To update the TOS or any Service-specific Rules, we will both post the
    changed version and its effective date at
    <a href="http://www.rcp-forge.org/modules/xfmod/tos/tos.php">http://www.rcp-forge.org/modules/xfmod/tos/tos.php.</a>. Concurrently with any change to the
...
<p>
    myXoopsForge reserves the right at any time and from time to time to modify
    or discontinue, temporarily or permanently, myXoopsForge or any Service
    ...
    myXoopsForge shall not be liable to any user or other third party for any
...
<p>
    myXoopsForge is a website owned and operated by myXoopsForge, for
    ...
    myXoopsForge (the "Purpose"). myXoopsForge currently offers users access to a
...
<p>
    ...
    thereunder. myXoopsForge cannot and will not be liable for any loss or
    ...
    myXoopsForge of any unauthorized use of his or her password or account or any
    other breach of security and (b) ensure that he or she exits from his or her
    account at the end of each session.
</p>
<p>
    myXoopsForge handles user Registration Data in accordance with the
    myXoopsForge Privacy Policy accessible at
    <a href="http://www.rcp-forge.org/modules/xfmod/tos/privacy.php">http://www.rcp-forge.org/modules/xfmod/tos/privacy.php</a>.
</p>
<p>
    <B>4. CONTENT</B>
</p>
<p>
    ...
    that the user, and not myXoopsForge, is entirely responsible for all Content
    that he or she uploads, posts, emails or otherwise transmits via myXoopsForge
    or any Service. No user shall transmit Content or otherwise conduct or
    participate in any activities on myXoopsForge and/or any Service which, in
    the opinion of myXoopsForge's counsel, are prohibited by law in applicable
...
<p>
    myXoopsForge will not pre-screen or review Content, but myXoopsForge reserves
    the right to refuse or delete any Content of which it becomes aware which it
    reasonably deems not to fulfill the Purpose. In addition, myXoopsForge shall
    ...
    otherwise illegal. myXoopsForge, in its sole and absolute discretion, may
    ...
    us to protect the rights, property or personal safety of myXoopsForge, its
    users and the public. myXoopsForge does not control the Content posted via
    the Service and, as such, does not guarantee the accuracy, integrity or
    quality of such Content. Under no circumstances will myXoopsForge be liable
    ...
    transmitted via myXoopsForge or any Service thereon.
</p>
<p>
    Each user, by using myXoopsForge or any Service, may be exposed to Content
...
<p>
    ...
    myXoopsForge ("Source Code") shall be subject to the OSI-approved license
    applicable to such Source Code, or to such other licensing arrangements that
    may be approved by myXoopsForge as applicable to such Source Code.
</p>
<p>
    With respect to text or data entered into and stored by publicly-accessible
    site features such as message boards and bug trackers ("myXoopsForge Public
    Content"), the submitting user retains ownership of such myXoopsForge Public
    ...
    is owned by myXoopsForge. In each such case, the submitting user grants
    myXoopsForge the royalty-free, perpetual, irrevocable, non-exclusive and
...
<p>
    With respect to Content posted to private areas of myXoopsForge, i.e.,
    private myXoopsForge development tools or myXoopsForge Mail, the submitting
    user may grant to myXoopsForge or other users such rights and licenses as the
    submitting user deems appropriate.
</p>
<p>
    Content located on any myXoopsForge-hosted subdomain which is subject to the
    ...
    such other licensing arrangements that may be approved by myXoopsForge as
...
<p>
    myXoopsForge may establish general practices and limits concerning use of the
    Services, as defined by posted Service-specific Rules. While myXoopsForge
    will use reasonable efforts to back up site data and make such data
    available in the event of loss or deletion, myXoopsForge has no
    ...
    by any Service. myXoopsForge reserves the right to mark as "inactive" and
    archive accounts and/or projects that are inactive for an extended period of
    time. myXoopsForge reserves the right to change these general practices and
...
<p>
    myXoopsForge's termination of any user's access to myXoopsForge or any Service
    hereunder may be effected without notice and, on such termination,
    myXoopsForge may immediately deactivate or delete user's account and/or bar
    any further access to such files, that Service or myXoopsForge. myXoopsForge
...
<p>
    ...
    governmental order, myXoopsForge shall make reasonable efforts to make
...
<p>
    myXoopsForge, any Service or a third party may provide links to other
    Websites. myXoopsForge exercises no control whatsoever over such other
    ...
    materials thereon. myXoopsForge shall not be responsible or liable, directly
...
<p>
    Each user shall indemnify, defend and hold harmless each of myXoopsForge and its affiliates and their respective officers, employees
    and agents, and any of myXoopsForge's website partners from any and all
    ...
    claims arising out of that user's use of myXoopsForge; his or her submission,
    ...
    PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS AND myXoopsForge ASSUMES NO
    ...
    OF DATA WHICH RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL. myXoopsForge
    ...
    myXoopsForge MAKES NO WARRANTY THAT (i) myXoopsForge OR ANY SERVICE WILL MEET
    ...
    EXCLUDING ONLY DAMAGES ARISING OUT OF MYXOOPSFORGE`S GROSS NEGLIGENCE OR
    WILLFUL MISCONDUCT, MYXOOPSFORGE. SHALL NOT BE LIABLE FOR ANY
    ...
    MATTER RELATING TO myXoopsForge OR ANY SERVICE. IN NO EVENT SHALL NOVELL'S
    ...
    DOES NOT AND CANNOT CONTROL THE ACTIONS OF myXoopsForge USERS,
    ...
    WE DO NOT GUARANTEE CONTINUOUS UNINTERRUPTED OR SECURE ACCESS TO myXoopsForge
...
<p>
    myXoopsForge, the myXoopsForge logo and other myXoopsForge trademarks, service
    marks, and product and service names are trademarks of myXoopsForge.
    (the "myXoopsForge Marks").
    All other marks are property of their respective owners. Users may display or use the
    myXoopsForge Marks in only in accordance with myXoopsForge`s Trademark Use Guidelines.
</p>
<p>
    <b>11. COPYRIGHTS</b>
</p>
<p>
    myXoopsForge respects the intellectual property of all parties and we ask our
    ...
    that user or third party should provide myXoopsForge with the following
    ...
    myXoopsForge receives such a claim, myXoopsForge reserves the right to refuse
...
<p>
    The TOS constitute the entire agreement between each user and myXoopsForge
...
<p>
    ...
    or any other matters to the myXoopsForge Support Manager at
    webmaster@myxoopsforge.org.
</p>
<p>
    myXoopsForge are trademarks of myXoopsForge.
    ...
    Service governing usage of this site at <a href="http://www.rcp-forge.org/modules/xfmod/tos/tos.php">http://www.rcp-forge.org/modules/xfmod/tos/tos.php</a>.
    For myXoopsForge privacy policy information, please see
    <a href="http://www.rcp-forge.org/modules/xfmod/tos/privacy.php">hhttp://www.rcp-forge.org/modules/xfmod/tos/privacy.php</a>. Content owned by Novell is
    copyright 2005 myXoopsForge. All rights reserved.
</p>
<br>
<HR><br>
