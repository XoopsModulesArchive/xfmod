...
function grpGetApprovalMessage($unix_group, $full_group, $group_id, $type = 1)
{
    ...
    $message['body'] = 'Your '
                          . $prjtype
                          . " registration for $site has been approved.\n"
                          . "\n"
                          . $uprjtype
                          . ' Full Name: '
                          . $full_group
                          ...
                          . $prjtype
                          . '. This can be done by visiting your '
                          . $prjtype
                          . ' '
                          . "page while logged in, and selecting '"
                          . $uprjtype
                          . " Admin' from the menus "
                          . 'on the top (or by visiting <'
                          . $xoopsConfig['xoops_url']
                          . '/modules/xfmod/'
                          . $prjtype
                          . '/admin/?group_id='
                          ...
                          . 'NOTICE: Your '
                          . $prjtype
                          . ' will also not appear in the Trove Software Map (primary '
                          . 'list of '
                          . $plprjtype
                          . " hosted on $site which offers great flexibility in "
                          . 'browsing and search) until you categorize it in the '
                          . $prjtype
                          . ' administration '
                          . 'screens. So that people can find your '
                          . $prjtype
