...
<p>
A person's use of XOOPS Development Forge and any of its Services (as defined below) at
any time is subject to XOOPS Development Forge's then-current Terms of Service (\"TOS\"),
which may be updated from time to time as set forth below. Each user can
review the then-current TOS at any time at:
<a href=\"".XOOPS_URL."/modules/xfmod/tos/tos.php\">http://dev.xoopscube.org/modules/xfmod/tos/tos.php</a>. In addition, each user's use of
...
reference into the TOS. A user's use of XOOPS Development Forge and/or its Services
constitutes full acceptance of and agreement to the TOS; if a user does not
accept our TOS, he or she is not granted rights to use XOOPS Development Forge or any of
its Services, as defined herein, and should refrain from accessing
XOOPS Development Forge and its Services.
</p>
<p>
To update the TOS or any Service-specific Rules, we will both post the
changed version and its effective date at
<a href=\"".XOOPS_URL."/modules/xfmod/tos/tos.php\">http://dev.xoopscube.org/modules/xfmod/tos/tos.php</a>. Concurrently with any change to the
...
<p>
The XOOPS Development Forge reserves the right at any time and from time to time to modify
or discontinue, temporarily or permanently, XOOPS Development Forge or any Service
...
XOOPS Development Forge shall not be liable to any user or other third party for any
...
<p>
The XOOPS Development Forge is a website owned and operated by XOOPS Organisation, for
...
XOOPS Organisation (the \"Purpose\"). The XOOPS Development Forge currently offers users access to a
...
thereunder. The XOOPS Development Forge cannot and will not be liable for any loss or
...
The XOOPS Development Forge of any unauthorized use of his or her password or account or any
other breach of security and (b) ensure that he or she exits from his or her
account at the end of each session.
</p>
<p>
The XOOPS Development Forge handles user Registration Data in accordance with the
XOOPS Privacy Policy accessible at
<a href=\"".XOOPS_URL."/modules/xfmod/tos/privacy.php\">http://dev.xoopscube.org/modules/xfmod/tos/privacy.php</a>.
</p>
<p>
<B>4. CONTENT</B>
</p>
...
that the user, and not the XOOPS Development Forge, is entirely responsible for all Content
that he or she uploads, posts, emails or otherwise transmits via the XOOPS Development Forge
or any Service. No user shall transmit Content or otherwise conduct or
participate in any activities on the XOOPS Development Forge and/or any Service which, in
the opinion of the XOOPS Development Forge's counsel, are prohibited by law in applicable
...
<p>
The XOOPS Development Forge will not pre-screen or review Content, but the XOOPS Development Forge reserves
the right to refuse or delete any Content of which it becomes aware which it
reasonably deems not to fulfill the Purpose. In addition, the XOOPS Development Forge shall
...
otherwise illegal. The XOOPS Development Forge, in its sole and absolute discretion, may
...
us to protect the rights, property or personal safety of XOOPS Development Forge, its
users and the public. The XOOPS Development Forge does not control the Content posted via
the Service and, as such, does not guarantee the accuracy, integrity or
quality of such Content. Under no circumstances will the XOOPS Development Forge be liable
...
transmitted via XOOPS Development Forge or any Service thereon.
</p>
<p>
Each user, by using the XOOPS Development Forge or any Service, may be exposed to Content
...
the XOOPS Development Forge (\"Source Code\") shall be subject to the OSI-approved license
applicable to such Source Code, or to such other licensing arrangements that
may be approved by the XOOPS Development Forge as applicable to such Source Code.
</p>
<p>
With respect to text or data entered into and stored by publicly-accessible
site features such as message boards and bug trackers (\"the XOOPS Development Forge Public
Content\"), the submitting user retains ownership of such the XOOPS Development Forge Public
...
is owned by the XOOPS Development Forge. In each such case, the submitting user grants
the XOOPS Development Forge the royalty-free, perpetual, irrevocable, non-exclusive and
...
<p>
With respect to Content posted to private areas of the XOOPS Development Forge, i.e.,
private the XOOPS Development Forge development tools or the XOOPS Development Forge Mail, the submitting
user may grant to the XOOPS Development Forge or other users such rights and licenses as the
submitting user deems appropriate.
</p>
<p>
Content located on any XOOPS Development Forge-hosted subdomain which is subject to the
...
such other licensing arrangements that may be approved by the XOOPS Development Forge as
...
<p>
The XOOPS Development Forge may establish general practices and limits concerning use of the
Services, as defined by posted Service-specific Rules. While the XOOPS Development Forge
will use reasonable efforts to back up site data and make such data
available in the event of loss or deletion, the XOOPS Development Forge has no
...
by any Service. The XOOPS Development Forge reserves the right to mark as \"inactive\" and
archive accounts and/or projects that are inactive for an extended period of
time. The XOOPS Development Forge reserves the right to change these general practices and
...
<p>
The XOOPS Development Forge's termination of any user's access to the XOOPS Development Forge or any Service
hereunder may be effected without notice and, on such termination,
the XOOPS Development Forge may immediately deactivate or delete user's account and/or bar
any further access to such files, that Service or the XOOPS Development Forge. The XOOPS Development Forge
...
governmental order, the XOOPS Development Forge shall make reasonable efforts to make
...
<p>
The XOOPS Development Forge, any Service or a third party may provide links to other
Websites. The XOOPS Development Forge exercises no control whatsoever over such other
...
materials thereon. The XOOPS Development Forge shall not be responsible or liable, directly
...
<p>
Each user shall indemnify, defend and hold harmless each of the XOOPS Development Forge and its affiliates and their respective officers, employees
and agents, and any of XOOPS`s website partners from any and all
...
claims arising out of that user's use of the XOOPS Development Forge; his or her submission,
...
PROVIDED ON AN \"AS IS\" AND \"AS AVAILABLE\" BASIS AND the XOOPS Development Forge ASSUMES NO
...
OF DATA WHICH RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL. XOOPS Development Forge
...
XOOPS Development Forge MAKES NO WARRANTY THAT (i) the XOOPS Development Forge OR ANY SERVICE WILL MEET
...
EXCLUDING ONLY DAMAGES ARISING OUT OF XOOPS'S GROSS NEGLIGENCE OR
WILLFUL MISCONDUCT, the XOOPS Development Forge SHALL NOT BE LIABLE FOR ANY
DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES,
INCLUDING BUT NOT LIMITED TO DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE,
DATA OR OTHER INTANGIBLE LOSSES (EVEN IF the XOOPS Development Forge HAS BEEN ADVISED
...
MATTER RELATING TO the XOOPS Development Forge OR ANY SERVICE. IN NO EVENT SHALL XOOPS Development Forge`S
...
TERMS OF SERVICE EXTEND RIGHTS TO ANY THIRD PARTY. AS NOTED ABOVE, XOOPS
DOES NOT AND CANNOT CONTROL THE ACTIONS OF the XOOPS Development Forge USERS,
...
WE DO NOT GUARANTEE CONTINUOUS UNINTERRUPTED OR SECURE ACCESS TO XOOPS Development Forge
...
<p>
The XOOPS Development Forge respects the intellectual property of all parties and we ask our
...
that user or third party should provide the XOOPS Development Forge with the following
...
the XOOPS Development Forge receives such a claim, the XOOPS Development Forge reserves the right to refuse
or delete Content as described under Section 4 hereto, or to terminate a
user's account in accordance with Section 7.
</p>
<p>
<b>11. GENERAL INFORMATION</b>
</p>
<p>
The TOS constitute the entire agreement between each user and the XOOPS Development Forge
...
each user and the XOOPS Development Forge shall be governed by the laws of the State of
...
or any other matters to the XOOPS Development Forge Support Manager at
<a href=\"mailto:development@xoopscube.org\">development@xoopscube.org</a>.
</p>
<BR /><HR /><BR />
...
constitute your legal signature on this document.</p>");
?>