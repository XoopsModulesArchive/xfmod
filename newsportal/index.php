...
$GLOBALS['xoopsOption']['template_main'] = 'newsportal/xfmod_index.html';
...
if ($group_id) {
    ...
    $extsql = 'SELECT forum_name,forum_desc_name FROM ' . $xoopsDB->prefix('xf_forum_nntp_list') . " WHERE group_id='$group_id'";
    ...
    if (!$extres || $extrows < 1) {
        ...
        while (false !== ($extrow = $xoopsDB->fetchArray($extres))) {
