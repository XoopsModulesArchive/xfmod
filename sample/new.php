...
$GLOBALS['xoopsOption']['template_main'] = 'sample/xfmod_new.html';
...
if ($group_id) {
    ...
    if ('add' == $op) {
        ...
        $query = 'INSERT INTO ' . $xoopsDB->prefix('xf_sample_data') . ' ' . '(stateid,title,data,createdate,updatedate,created_by,sample_group,description) ' . "VALUES ('3'," // state = 3 == pending
                 . "'" . $ts->addSlashes($sample_name) . "'," . "'" . $filename . "'," //."'".$ts->addSlashes($data)."',"
                 . "'" . time() . "'," . "'" . time() . "'," . "'" . $user_id . "'," . "'" . $sample_group . "'," . "'" . $ts->addSlashes($description) . "')";
