...
$GLOBALS['xoopsOption']['template_main'] = 'tracker/xfmod_add.html';
...
*/
$content .= $ts->displayTarea($ath->getSubmitInstructions());
$content .= '<P>
