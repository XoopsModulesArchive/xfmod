 ...
 */
$GLOBALS['xoopsOption']['template_main'] = 'tracker/xfmod_detail.html';
...
$content = '<H4>[ #' . $ah->getID() . ' ] ' . $ts->displayTarea($ah->getSummary()) . '</H4>';
...
$content .= '
	...
	<TR><TD COLSPAN="2"><B>' . _XF_TRK_SUMMARY . ':<BR><I>' . $ts->displayTarea($ah->getSummary()) . '</I></B></TD></TR>
