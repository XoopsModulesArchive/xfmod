 ...
 */
$GLOBALS['xoopsOption']['template_main'] = 'pm/xfmod_mod_task.html';
...
$content .= "
  	...
  	<TR>
		...
		<BR>
		<INPUT TYPE='text' name='summary' size='40' MAXLENGTH='65' VALUE='" . $ts->htmlSpecialChars(unofficial_getDBResult($result, 0, 'summary')) . "'>
		</TD>
	</TR>
