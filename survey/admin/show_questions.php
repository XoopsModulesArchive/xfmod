...
if (1 != $popup) {
    $GLOBALS['xoopsOption']['template_main'] = 'survey/admin/xfmod_show_questions.html';
...
$sql = 'SELECT sq.question_id,sq.question,sqt.type ' . 'FROM ' . $xoopsDB->prefix('xf_survey_questions') . ' sq,' . $xoopsDB->prefix('xf_survey_question_types') . ' sqt ' . 'WHERE sqt.id=sq.question_type ' . "AND sq.group_id='$group_id' " . 'ORDER BY sq.question_id DESC';
