...
$GLOBALS['xoopsOption']['template_main'] = 'survey/admin/xfmod_browse_surveys.html';
...
function ShowResultsEditSurvey($result)
{
	...
	for ($j = 0; $j < $rows; $j++) {
        ...
        $content .= "<td><a href='" . XOOPS_URL . '/modules/xfmod/survey/admin/edit_survey.php' . "?group_id=$group_id&survey_id=" . unofficial_getDBResult($result, $j, 0) . "'>" . unofficial_getDBResult($result, $j, 0) . '</a></td>';
