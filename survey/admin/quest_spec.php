    ...
    <tr>
        <td>
            <table border='0' cellpadding='0' cellspacing='0' valign='top' width='100%'>
                <tr>
                    <td><a href="javascript:questMoveUp()">
                            <img src="<?php echo $uparrowUrl; ?>" border="1" width="14" height="14" alt="Up Arrow"></a></td>
                </tr>
                <tr>
                    <td><a href="javascript:questMoveDown()">
                            <img src="<?php echo $downarrowUrl; ?>" border="1" width="14" height="14" alt="Down Arrow"></a></td>
                </tr>
            </table>
        </td>
        ...
        <td>
            <table border='0' cellpadding='0' cellspacing='0' valign='top' width='100%'>
                ...
                <tr>
                    <td><select name="squestions" size="10" width=200 style="width: 200px"
                                onFocus="sfocused()">

                            <?php
                            if (mb_strlen(trim($survey_questions)) > 0) {
                                $qra = preg_preg_split("/[\s,]+/", $survey_questions);

                                $sql = 'SELECT * FROM ' . $xoopsDB->prefix('xf_survey_questions') . " WHERE question_id='" . $qra[0] . "'";

                                for ($qi = 1, $qiMax = count($qra); $qi < $qiMax; $qi++) {
        ...
        <td>
            <table border='0' cellpadding='0' cellspacing='0' valign='top' width='100%'>
                <tr>
                    <td><a href="javascript:questMoveLeft()">
                            <img src="<?php echo $leftarrowUrl; ?>" border="1" width="14" height="14" alt="Add Question"></a></td>
                </tr>
                <tr>
                    <td><a href="javascript:questMoveRight()">
                            <img src="<?php echo $rightarrowUrl; ?>" border="1" width="14" height="14" alt="Remove Question"></a></td>
                </tr>
            </table>
        </td>
                ...
                <tr>
                    <td>
                        <select name="aquestions" size="10" width=200 style="width: 200px"
                            ...
                            $sql = 'SELECT * FROM ' . $xoopsDB->prefix('xf_survey_questions') . " WHERE group_id='" . $group_id . "'";

                            if (count($qra) > 0) {
                                for ($qi = 0, $qiMax = count($qra); $qi < $qiMax; $qi++) {
