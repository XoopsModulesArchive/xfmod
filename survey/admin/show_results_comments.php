...
$GLOBALS['xoopsOption']['template_main'] = 'survey/admin/xfmod_show_results_comments.html';
...
$content .= '<h4>' . _XF_SUR_QUESTION . ': ' . $ts->htmlSpecialChars(unofficial_getDBResult($result, 0, 'question')) . '</H4>';
$content .= '<P>';
