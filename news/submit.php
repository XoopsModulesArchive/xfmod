...
$GLOBALS['xoopsOption']['template_main'] = 'news/xfmod_submit.html';
    ...
    if ($post_changes) {
        ...
        if ($summary && $details) {
            ...
            */
            ...
            $sql = 'INSERT INTO ' . $xoopsDB->prefix('xf_news_bytes') . ' ' . '(group_id,submitted_by,is_approved,date,forum_id,summary,details) ' . 'VALUES (' . "'$group_id'," . "'" . $xoopsUser->getVar('uid') . "'," . "'0'," . "'" . time() . "'," . "'$new_id'," . "'" . $ts->addSlashes(
                $summary
