...
$GLOBALS['xoopsOption']['template_main'] = 'community/xfmod_members.html';
...
if ($group_id) {
    ...
    if ('add' == $membership) {
        ...
        foreach ($maillists as $suffix => $desc) {
            ...
            $content .= '<input type="hidden" name="group_id'
                        . $maillistcount
                        . '" value="'
                        . $group_id
                        . "\">\n"
                        ...
                        . "\"></td></tr>\n"
                        . '<input type="hidden" name="maillistname'
                        . $maillistcount
                        . '" value="'
                        . urlencode($project->getUnixName() . '-' . $suffix)
                        . '">'
                        . "<tr><td class'bg31'><input type=\"checkbox\" name=\"subscribeme"
                        . $maillistcount
                        . '" value="y"><b>'
                        . $project->getUnixName()
                        . '-'
