 ...
 *
 * @version   $Id: foundry_html_admin.php,v 1.2 2004/10/09 23:57:20 praedator Exp $
 */
...
project_admin_header(['title' => 'Project Admin: ' . group_getname($group_id), 'group' => $group_id, 'pagename' => 'foundry_html_admin']);
...
<P>
	...
	<TABLE WIDTH=75%><TR><TD>';
        ...
        if ($preview) {
            ...
            $freeform_html = stripslashes(db_result(db_query("SELECT $field FROM foundry_data WHERE foundry_id='$group_id'"), 0, (string)$field));
	...
	<TEXTAREA NAME="freeform_html" ROWS="25" COLS="70" WRAP="SOFT">' . htmlspecialchars($freeform_html, ENT_QUOTES | ENT_HTML5) . '</TEXTAREA>
