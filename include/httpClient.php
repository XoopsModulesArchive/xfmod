...
@SYNOPSIS
	...
	$http->connect( "localhost", 80 ) || die( "connect problem" );
...
class Net_HTTP_Client
{
     ...
     * @param URL $uri       (relative) of the resource to lock
...
<D:lockscope><D:$lockScope></D:lockscope>\n<D:locktype><D:$lockType></D:locktype>
     ...
     * @param URL $uri       (relative) of the resource to unlock
     * @param the $lockToken lock token given at lock time, eg: opaquelocktoken:e71d4fae-5dec-22d6-fea5-00a0c91e6be4
