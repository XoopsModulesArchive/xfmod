...
if (file_exists(XOOPS_ROOT_PATH . '/modules/xfmod/language/' . $xoopsConfig['language'] . '/global.php')) {
    require XOOPS_ROOT_PATH . '/modules/xfmod/language/' . $xoopsConfig['language'] . '/global.php';
} else {
    require XOOPS_ROOT_PATH . '/modules/xfmod/language/english/global.php';
}
...
if (file_exists(XOOPS_ROOT_PATH . '/modules/xfmod/language/' . $xoopsConfig['language'] . '/mailmessages.php')) {
    require XOOPS_ROOT_PATH . '/modules/xfmod/language/' . $xoopsConfig['language'] . '/mailmessages.php';
} else {
    require XOOPS_ROOT_PATH . '/modules/xfmod/language/english/mailmessages.php';
}
// XoopsForge language file
if (file_exists(XOOPS_ROOT_PATH . '/modules/xfmod/language/' . $xoopsConfig['language'] . '/' . $langfile)) {
    require XOOPS_ROOT_PATH . '/modules/xfmod/language/' . $xoopsConfig['language'] . '/' . $langfile;
} else {
    require XOOPS_ROOT_PATH . '/modules/xfmod/language/english/' . $langfile;
}
