...
require_once cache_require __DIR__ . '/license', 'get_license_list()', 86400;
...
function get_license_list()
{
    ...
    $sql = 'SELECT trove_cat_id, parent, shortname, fullname, description' . ' FROM ' . $xoopsDB->prefix('xf_trove_cat') . " WHERE fullpath_ids LIKE '$licenseID ::%'";
    /*
