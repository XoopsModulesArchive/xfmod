 ...
 *
 * @version   $Id: foundry_home.php,v 1.2 2004/10/09 23:57:20 praedator Exp $
 */
...
$HTML->header(['title' => $foundry->getUnixName() . ' - Community', 'group' => $group_id, 'pagename' => 'foundry', 'titlevals' => [$foundry->getPublicName()], 'sectionvals' => [$foundry->getPublicName()]]);
...
$HTML->box1_top('Community News', '#f4f5f7');
    ...
    for ($j = 0; $j < $rows; $j++) {
        echo '
			...
			<A HREF="/forum/forum.php?forum_id=' . db_result($result, $j, 'group_forum_id') . '">' .
             ...
             html_image('images/ic/cfolder15.png', '15', '13', ['BORDER' => '0']) . '&nbsp;' .
