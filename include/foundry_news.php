 ...
 *
 * @version   $Id: foundry_news.php,v 1.2 2004/10/09 23:57:20 praedator Exp $
 */
...
if (user_ismember($group_id, 'A')) {
    ...
    */
    ...
    project_admin_header(['title' => 'NewsBytes', 'group' => $group_id, 'pagename' => 'foundry_news']);
    ...
    if ($approve) {
        ...
        */
		...
		<B>Submitted for Project:</B> <a href="/projects/' .
             ...
             mb_strtolower(db_result($result, 0, 'unix_group_name')) .
		...
		<INPUT TYPE="RADIO" NAME="status" VALUE="1"> Approve For Communityy Page<BR>
