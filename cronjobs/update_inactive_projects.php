...
while (false !== ($row = db_fetch_array($result1))) {
    ...
    if (0 == db_numrows($result2)) {
        ...
        $base_sql = 'SELECT dfa.month,dfa.day FROM '
                    . $dbprefix
                    . '_xf_frs_dlstats_file_agg dfa, '
                    . $dbprefix
                    . '_xf_frs_package p, '
                    . $dbprefix
                    . '_xf_frs_release r, '
                    . $dbprefix
                    . "_xf_frs_file f where p.group_id='"
                    . $row['group_id']
                    . "' and r.package_id=p.package_id and f.release_id=r.release_id and dfa.file_id=f.file_id and dfa.downloads>0";
