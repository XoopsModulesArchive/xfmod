...
require_once XOOPS_ROOT_PATH . '/class/httpClient.php';
require_once XOOPS_ROOT_PATH . '/class/checkurl.php';

$pathinfo = checkURL($_SERVER['PATH_INFO']);
if (mb_strrpos($pathinfo, 'logout') == mb_strlen($pathinfo) - 6) {
    $logout = true;
}
$mmsvr = '';
...
$main_subsections = ['general', 'members', 'privacy', 'nondigest', 'digest', 'bounce', 'archive', 'gateway', 'autoreply', 'logout'];
$adm_subsections = ['admindb', 'listinfo', 'edithtml'];
