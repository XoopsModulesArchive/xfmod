...
if ($group_id) {
    ...
    if ('y' == $dosub) {
        ...
        } elseif (!maillist_subscribe(0, 0, $_SERVER['SERVER_NAME'], $list, 0, $email, $pw, $digest)) {
            $feedback = _XF_ML_SUBFAILED;
        } else {
            echo '<h5>' . _XF_ML_NOWSUBDTO . ' ' . $list . '</h5>' . '<br><br>' . '<a href="' . XOOPS_URL . '/modules/xfmod/project/?' . $project->getUnixName() . '">' . _LOCAL_XF_ML_RETURNTOPRJPAGE . '</a>';
        }
    }
    ...
    if ('y' != $dosub || '' != $feedback) {
        ...
        echo "<form action='"
             . XOOPS_URL
             . "/modules/xfmod/maillist/subscribe.php' method='POST'>\n"
             ...
             . urlencode($list)
             . "'>\n"
             . "<tr class='bg3'><td colspan='2' align='left'>"
             . sprintf(_XF_ML_SUB_INSTRUCTIONS, $list)
             . "</td></tr>\n"
             . "<tr class='bg2'><td>"
             . _XF_ML_ENTER_EMAIL
             . ":</td>\n"
             ...
             . "<tr class='bg3'><td colspan='2' align'left'>"
             . _XF_ML_PWD_INSTRUCTIONS
             . "<p> <b>** Please note</b>, in order to see the mailing list show up on your account page, please make sure that you are <a href='"
             . XOOPS_URL
             . '/user.php?xoops_redirect='
             . $_SERVER['PHP_SELF']
             . '?'
             . urlencode($_SERVER['QUERY_STRING'])
             . "'>logged in</a> when you subscribe.</td></tr>\n"
             . "<tr class='bg2'><td>"
             . _XF_ML_ENTER_PWD
             . ":</td>\n"
             ...
             . _XF_ML_DIGESTMAIL
             . "?</td>\n"
             . "<td width='60%' align='left'><input type='radio' name='digest' value='0' checked> "
             . _XF_ML_NO
             . "<input type='radio' name='digest' value='1'> "
             . _XF_ML_YES
             . "</td></tr>\n"
             . "<tr class='bg2'><td colspan='2' align='left'><input type='submit' name='submit' value='"
             . _XF_ML_SUBSCRIBE
             . "'></td></tr>\n"
             . "</table></form>\n";
    }
