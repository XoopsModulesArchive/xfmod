...
if ($xoopsUser->isAdmin($xoopsModule->mid())) {
    ...
    $fp = @fopen('http://cforge.sourceforge.net/modules/xfmod/xoopsforge_version.php', 'rb');
    ...
    if (!mb_strstr($data, '|')) {
        ...
        <table align="center" border="0" cellspacing="0" cellpadding="3" class="box-table"><br>
            <tr>
                <td valign="middle"><b>Latest Version:</b>
                </th>
                <td valign="middle"><?php echo $ver_arr[0]; ?></td>
            </tr>
            <tr>
                <td valign="middle"><b>Release Date:</b>
                </th>
                <td valign="middle"><?php echo $ver_arr[1]; ?></td>
            </tr>
            <tr>
                <td valign="middle"><b>Download Locations:</b>
                </th>
