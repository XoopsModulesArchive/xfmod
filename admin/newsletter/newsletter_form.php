...
if ($xoopsUser->isAdmin($xoopsModule->mid())) {
    ...
    function show_pref()
    {
        ...
        $send_date_hour = [
            $xoopsNewsLetterConfig['next_send_date_hour'] => $xoopsNewsLetterConfig['next_send_date_hour'],
            '01' => '01',
            '02' => '02',
            '03' => '03',
            '04' => '04',
        ...
        $send_date_day = [
            $xoopsNewsLetterConfig['next_send_date_day'] => $xoopsNewsLetterConfig['next_send_date_day'],
            '01' => '01',
            '02' => '02',
            '03' => '03',
            '04' => '04',
        ...
        $send_date_month = [
            $xoopsNewsLetterConfig['next_send_date_month'] => $xoopsNewsLetterConfig['next_send_date_month'],
            '01' => '01',
            '02' => '02',
            '03' => '03',
            '04' => '04',
        ...
        $send_date_year = [
            $xoopsNewsLetterConfig['next_send_date_year'] => $xoopsNewsLetterConfig['next_send_date_year'],
            '' . date('Y') => date('Y'),
            '' . date('Y') + 1 => date('Y') + 1,
            '' . date('Y') + 2 => date('Y') + 2,
        ];
        ...
        $send_interval_days = [
            $xoopsNewsLetterConfig['next_send_interval_days'] => $xoopsNewsLetterConfig['next_send_interval_days'],
            '01' => '01',
            '02' => '02',
            '03' => '03',
            '04' => '04',
        ...
        $user_select->addOptionArray(XoopsUser::getAllUsersList([], $orderby = 'uname ASC'));
